...
export default function BatchTableOne({ posts }) {
  ...
  return (
    <div style={{ maxWidth: "100%" }}>
      ...
      <MaterialTable
        icons={tableIcons}
        title="सत्र न्यायालयो में गिरोहबन्द अधिनियम के अन्तर्गत अभियोजन संवर्ग द्वारा अभियोजित वादो का विवरण"
        columns={[
          {
            title: "जनपद का नाम",
            field: "district",
        ...
        options={{
          filtering: true,
          exportFileName: `सत्र न्यायालयो में गिरोहबन्द अधिनियम के अन्तर्गत अभियोजन संवर्ग द्वारा अभियोजित वादो का विवरण`,
