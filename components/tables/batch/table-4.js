...
export default function BatchTableOne({ posts }) {
  ...
  return (
    <div style={{ maxWidth: "100%" }}>
      ...
      <MaterialTable
        icons={tableIcons}
        title="सत्र न्यायालयो में भा0द0वि0 के अन्तर्गत डी०जी०सी संवर्ग द्वारा अभियोजित वादो का विवरण"
        columns={[
          {
            title: "जनपद का नाम",
            field: "district",
        ...
        options={{
          filtering: true,
          exportFileName: `सत्र न्यायालयो में भा0द0वि0 के अन्तर्गत डी०जी०सी संवर्ग द्वारा अभियोजित वादो का विवरण`,
